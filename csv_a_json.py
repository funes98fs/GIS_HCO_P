...
if not os.path.exists(archivo_csv):
    ...
    try:
        ...
        columnas = ['ID', 'uunn', 'ntcse', 'amt', 'direccion', 'wgsy', 'wgsx']
        ...
        # Guardar como JSON
        df.to_json('sed_datos.json', orient='records', force_ascii=False, indent=2)

        print("✅ Archivo 'sed_datos.json' creado correctamente.")
